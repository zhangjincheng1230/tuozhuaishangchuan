<template>
  <div class="kj-main">
    <el-container style = "height:calc(100% - 30px)">
      ...
      <km-check-box-query ref="kmcheckboxquery" :key="'tablebwb_check'"  :nodename="nodename"
                          :bsavesetting="true" :treedata="treedata" :currselectids.sync="currselectids" :mulselect.sync="mulselect" ></km-check-box-query>
    </el-container>
...
export default {
  ...
  created () {
    // this.filterText = typeof this.routerParam === 'undefined' ? '' : this.routerParam.pk_km
  },
  mounted () {
    // this.filterText = typeof this.routerParam === 'undefined' ? '' : this.routerParam.pk_km
  },
