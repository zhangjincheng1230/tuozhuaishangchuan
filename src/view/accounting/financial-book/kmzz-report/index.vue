    ...
    <div class="kj-container">
      <div class="kj-head">
        <div class="query-info">
          <selfhead ref="selfhead" :page-info="pageInfo" @query="query" :routerParam="routerParam" ></selfhead>
        </div>
      ...
      <div class="kj-main" v-loading="loading"
           element-loading-text="数据加载中，请稍候..."
           element-loading-spinner="el-icon-loading">
        <tablebwb  v-show="bxswbtable == false"  :alltabledata="tableData" :queryparam="queryparam"></tablebwb>
        <tablewb v-show="bxswbtable == true" :alltabledata="tableData" :queryparam="queryparam"></tablewb>
...
import selfhead from '@/view/accounting/financial-book/kmzz-report/components/head'
import tablebwb from '@/view/accounting/financial-book/kmzz-report/components/table_bwb'
import tablewb from '@/view/accounting/financial-book/kmzz-report/components/table_wb'
export default {
  name: 'kmzz-report',
  components: {
    BackToTop,
  ...
  methods: {
    query (formParam) {
      ...
      this.$api.kmzzReport.query(Object.assign(this.queryparam, this.pageInfo)).then(result => {
        if (result.success) {
    ...
    confirmPrint (val) {
      ...
      this.$api.kmzzReport.printPdf(this.nodename, Object.assign(this.queryparam, val, otherprintparam))
    },
    ...
    exportReport () {
      ...
      this.$api.kmzzReport.expExcel(this.nodename, Object.assign(this.queryparam, {titleperiod: qrydate, corpName: this.queryparam.corpobj.uname}))
    }
  }
}
</script>
