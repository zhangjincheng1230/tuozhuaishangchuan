...
export default {
  ...
  methods: {
    confirmExcelExport () {
      ...
      this.$api.YwhdReport.expExcel(this.nodename, Object.assign({
    ...
    confirmPrint (val) {
      ...
      this.$api.YwhdReport.printPdf(this.nodename, Object.assign({}, this.formParam, val, otherprintparam))
    },
    query () {
      this.loading = true
      ...
      this.$api.YwhdReport.query(this.formParam).then(result => {
        if (result.success) {
