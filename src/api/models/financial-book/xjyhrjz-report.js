...
export function query (param) {
  return post('/report/gl_rep_xjyhrjzact/queryAction', param)
}
// 查询辅助类别
...
export function expExcel (filename, param) {
  ...
  return exportExcel('/report/gl_rep_xjyhrjzact/export/excel', filename + '- (' + qrydate + ')', param)
}
// 打印
export function printPdf (filename, param) {
  return downloadFile('/report/gl_rep_xjyhrjzact/print', param)
}
